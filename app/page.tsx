      ...
      <div className="flex flex-col w-[800px]">
        ...
        <div>
          <div className="grid grid-cols-6 gap-4 px-6 py-4 text-white text-opacity-60">
            ...
            {blocks.map((block, i) => (
              <div key={i} className="grid grid-cols-6 gap-4 bg-white-opacity-02 hover:bg-white-opacity-05 px-6 py-[18px] rounded-2xl mb-1 text-white text-opacity-60 hover:text-opacity-100 hover:cursor-pointer">
